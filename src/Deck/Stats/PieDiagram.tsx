...
let labelsData:Array<'string'| undefined> = []
let backgroundColorData:Array<'string'| undefined> = []
let borderColorData:Array<'string'| undefined> = []
let dataData:Array<'string'| undefined> = []
let hoverBackgroundColorData:Array<'string'| undefined> = []
...
for (let deck in dataBase.DeckNames) {
  ...
  in stats -->*/
  dataBase.DeckNames[deck].data.filter((item,index,arr):void => {
