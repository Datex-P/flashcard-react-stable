...
const trashimg: string = require('../../../icons/trash.svg')
const pauseimg:string = require('../../../icons/pause.svg')
const editimg: string =  require('../../../icons/edit.svg')
const resetimg: string =  require('../../../icons/reset.svg')
const saveimg: string =  require('../../../icons/save.svg')
const playimg:string =  require('../../../icons/play.svg')
